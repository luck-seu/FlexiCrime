...
if __name__ == '__main__':
    ...
    test_crime_list = ['THEFT', 'ASSAULT 3 & RELATED OFFENSES', 'ROBBERY', 'DANGEROUS WEAPONS', 'SEX CRIMES', 'FORGERY']
    model_path_list = [
    ...
    for id in range(len(test_crime_list)):
        ...
        for i in range(len(hour_list)):
            pp_feature_dataset_name = '/home/tangjun/CrimePrediction_LAB_WIN/neural_stpp/train_data/NYC/{}/crime-pp-feature-{}hours.pkl'.format(
