...
if __name__ == '__main__':
    ...
    for i in range(4, 5):
        ...
        train_ds = FineTuningBaseDataSet(city_base_info=city_data_info, size=exp_args.dataset_size,
                                         ...
                                         self_adjustment=True, p_ratio=0.35)
    ...
    model_path = '/home/tangjun/CrimePrediction_LAB_WIN/experiment_v2/NYC/train_model/trained_NYC_model_con_maf1-0.361709_2023-12-14_19-53.pth'
