...
if __name__ == '__main__':
    ...
    city_data_info = np.load('/home/hongyi/CrimePrediction_LAB_WIN/data/NYC/city_base_info_dict_2016_2018.npy', allow_pickle=True).item()
    exp_args.crime_dim = city_data_info['n_crime_type']
    exp_args.grid_feature_dim = city_data_info['n_POI_cate']
    with open('/home/hongyi/CrimePrediction_LAB_WIN/data/NYC/train_data/crime-different-slot-ownid-{}-2016-2018.pkl'.format(now_crime_id), 'rb') as f:
    ...
    for i in range(4, 5):
        pp_feature_dataset_name = '/home/hongyi/CrimePrediction_LAB_WIN/neural_stpp/train_data/NYC/0/crime-pp-feature-{}hours.pkl'.format(
            hour_list[i])
