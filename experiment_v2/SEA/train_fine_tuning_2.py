...
if __name__ == '__main__':
    ...
    for i in range(4, 5):
        pp_feature_dataset_name = '/home/tangjun/CrimePrediction_LAB_WIN/neural_stpp/train_data/SEA/{}/crime-pp-feature-{}hours.pkl'.format(now_crime_id,
            hour_list[i])
        ...
        train_ds = FineTuningBaseDataSet(city_base_info=city_data_info, size=exp_args.dataset_size,
                                         ...
                                         self_adjustment=True, p_ratio=0.12)
