...
def change():
    exp_args.batch_size = 56
    exp_args.dataset_size = 10000
    exp_args.train_epoch = 15
...
if __name__ == '__main__':
    ...
    interval_choose = 4
    now_crimes = ['LARCENY-THEFT', 'ASSAULT OFFENSES', 'BURGLARY/BREAKING&ENTERING', 'FRAUD OFFENSES', 'TRESPASS OF REAL PROPERTY', 'ROBBERY']
    model_paths = [
        '/home/hongyi/CrimePrediction_LAB_WIN/experiment_v2/SEA/train_model/trained_0_fine_tuning_2024-01-09_23-05_f1-0.597479.pth',
        '/home/hongyi/CrimePrediction_LAB_WIN/experiment_v2/SEA/train_model/trained_1_fine_tuning_2024-01-10_10-02_f1-0.299445.pth',
        '/home/hongyi/CrimePrediction_LAB_WIN/experiment_v2/SEA/train_model/trained_2_fine_tuning_2024-01-10_19-54_f1-0.321908.pth',
        '/home/hongyi/CrimePrediction_LAB_WIN/experiment_v2/SEA/train_model/trained_5_fine_tuning_2024-01-16_12-47_f1-0.176955.pth',
        '/home/hongyi/CrimePrediction_LAB_WIN/experiment_v2/SEA/train_model/trained_6_fine_tuning_2024-01-16_16-45_f1-0.192621.pth',
        '/home/hongyi/CrimePrediction_LAB_WIN/experiment_v2/SEA/train_model/trained_8_fine_tuning_2024-01-15_20-10_f1-0.122856.pth'
    ]

    for crime_type in range(6):
        # load data
        # ['LARCENY-THEFT', 'ASSAULT OFFENSES', 'BURGLARY/BREAKING&ENTERING', 'FRAUD OFFENSES',
        #  'TRESPASS OF REAL PROPERTY', 'ROBBERY']
        # now_crime = 'LARCENY-THEFT'
        # now_crime = 'ASSAULT OFFENSES'
        # now_crime = 'BURGLARY/BREAKING&ENTERING'
        # now_crime = 'FRAUD OFFENSES'
        # now_crime = 'TRESPASS OF REAL PROPERTY'
        # now_crime = 'ROBBERY'
        ...
        city_data_info = np.load(('/home/hongyi/CrimePrediction_LAB_WIN/data/Seattle/city_base_info_dict_2020_2022.npy'),
                                 allow_pickle=True).item()
        exp_args.crime_dim = city_data_info['n_crime_type']
        exp_args.grid_feature_dim = city_data_info['n_POI_cate']
        with open(
                '/home/hongyi/CrimePrediction_LAB_WIN/data/Seattle/train_data/crime-different-slot-ownid-{}-2020-2022.pkl'.format(
                    now_crime_id), 'rb') as f:
            crime_dateset = pickle.load(f)
        f.close()

        with open(
                '/home/hongyi/CrimePrediction_LAB_WIN/data/Seattle/train_data/crime-different-slot-ownid-{}-2020-2022-CrimeNumCount.pkl'.format(
                    now_crime_id), 'rb') as f:
        ...
        for i in range(interval_choose, interval_choose + 1):
            pp_feature_dataset_name = '/home/hongyi/CrimePrediction_LAB_WIN/neural_stpp/train_data/SEA/{}/crime-pp-feature-{}hours.pkl'.format(
                now_crime_id,
                hour_list[i])
            ...
            degree = crime_test_len // 60
            crime_test_len = degree * 60
            ...
            test_ds = FineTuningBaseDataSet(city_base_info=city_data_info, size=crime_test_len,
                                            crime_dataset_all=crime_dataset_for_test, crime_dataset_all_count=crime_dataset_for_test_count, pp_feature=crime_pp_feature_dataset)
        ...
        # model_path = '/home/hongyi/CrimePrediction_LAB_WIN/experiment_v2/SEA/train_model/trained_NYC_model_con_2023-12-27_19-50_maf1-0.356492.pth'
        # model_path = '/home/hongyi/CrimePrediction_LAB_WIN/experiment_v2/SEA/train_model/trained_0_fine_tuning_2024-01-09_23-05_f1-0.597479.pth'
        # model_path = '/home/hongyi/CrimePrediction_LAB_WIN/experiment_v2/SEA/train_model/trained_1_fine_tuning_2024-01-10_10-02_f1-0.299445.pth'
        # model_path = '/home/hongyi/CrimePrediction_LAB_WIN/experiment_v2/SEA/train_model/trained_2_fine_tuning_2024-01-10_19-54_f1-0.321908.pth'
        # model_path = '/home/hongyi/CrimePrediction_LAB_WIN/experiment_v2/SEA/train_model/trained_5_fine_tuning_2024-01-16_12-47_f1-0.176955.pth'
        # model_path = '/home/hongyi/CrimePrediction_LAB_WIN/experiment_v2/SEA/train_model/trained_6_fine_tuning_2024-01-16_16-45_f1-0.192621.pth'
        # model_path = '/home/hongyi/CrimePrediction_LAB_WIN/experiment_v2/SEA/train_model/trained_8_fine_tuning_2024-01-15_20-10_f1-0.122856.pth'
        ...
        for epoch in range(1):
            ...
            with torch.no_grad():
                ...
                for tp in range(interval_choose, interval_choose + 1):
                    ...
                    out_diffs = out_res1 - out_res0
                    out_diffs = [out_diffs[i:i + 60] for i in
                                 range(0, len_out_res, 60)]
                    out_res0 = [out_res0[i:i + 60] for i in
                                range(0, len_out_res, 60)]
                    out_res1 = [out_res1[i:i + 60] for i in
                                range(0, len_out_res, 60)]
                    test_lables = [test_lables[i:i + 60] for i in
                                   range(0, len_test_lables, 60)]
                    test_lables_count = [test_lables_count[i:i + 60] for i in
                                         range(0, len_test_lables, 60)]
                    hrs = np.array([])
                    hrs_diff = np.array([])
                    k = 10
                    # for out0, out1, out_diff, test_lable in zip(out_res0, out_res1, out_diffs, test_lables):
                    #     min_k_indices = np.argpartition(out0, k)[:k]
                    #     max_k_indices = np.argpartition(out1, -k)[-k:]
                    #     max_diff_k_indices = np.argpartition(out_diff, -k)[-k:]
                    #     truth_k0 = test_lable[min_k_indices]
                    #     truth_k1 = test_lable[max_k_indices]
                    #     truth_diff_k = test_lable[max_diff_k_indices]
                    #     Hit = 0
                    #     Hit_diff = np.sum(truth_diff_k)
                    ...
                    #         hrs_diff = np.append(hrs, Hit_diff)

                    # hrs_max = len(hrs) * 10
                    # if hrs_max >= np.sum(test_lables):
                    #     HR = np.sum(hrs) / np.sum(test_lables)
                    #     HR_diff = np.sum(hrs_diff) / np.sum(test_lables)
                    # else:
                    #     HR = np.sum(hrs) / hrs_max
                    #     HR_diff = np.sum(hrs) / hrs_max
                    ...
                    aps = []
                    ndcgs = []
                    for out0, out1, test_lable, test_lable_count in zip(out_res0, out_res1, test_lables, test_lables_count):
                        ...
                        for PRE_index in range(0, k, 1):
                            if test_lable[min_pred0_k_index[PRE_index]] == 1 or test_lable[max_pred1_k_index[PRE_index]] == 1:
                        ...
                        for DCG_index in range(0, k, 1):
                            if test_lable[min_pred0_k_index[DCG_index]] == 1 or test_lable[max_pred1_k_index[DCG_index]] == 1:
                    ...
                    # file = open('/home/hongyi/CrimePrediction_LAB_WIN/data/SEA_hotspots_{}.pkl'.format(now_crime_id), 'wb')
