...
model_path = "/home/tangjun/CrimePrediction_LAB_PC/neural_stpp/trained_model/SEA/model0-1.pth"
crime_base_dataset = np.load('/home/tangjun/CrimePrediction_LAB_PC/neural_stpp/data/crimeSEA0/crime_seattle_LARCENY-THEFT_day3-1.npz')
...
if __name__ == "__main__":
    # get_dataset(0, 6)
    dataset_collection(0, '2023-05-09_20-55', 6, to_file='/home/tangjun/CrimePrediction_LAB_PC/data/Seattle/pp_data/2023-5-10_12-00-o1', order='-o1')
    # one_test()
