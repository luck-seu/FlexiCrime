...
model_path = "/home/tangjun/CrimePrediction_LAB_PC/neural_stpp/trained_model/NYC/model1-1.pth"
crime_base_dataset = np.load('/home/tangjun/CrimePrediction_LAB_PC/neural_stpp/data/crimeNYC1/crime_nyc_assault_day3-1.npz')
...
if __name__ == '__main__':
    # get_dataset(1, 3)
    # get_one()
    dataset_collection(1, '2023-05-09_15-15', 3, to_file='/home/tangjun/CrimePrediction_LAB_PC/data/NYC/pp_data/2023-5-10_12-00-o1', order='-o1')
    # multi_test()
    # one_test()
