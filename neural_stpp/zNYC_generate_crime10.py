...
model_path = "/home/tangjun/CrimePrediction_LAB_PC/neural_stpp/trained_model/NYC/model10-1.pth"
crime_base_dataset = np.load('/home/tangjun/CrimePrediction_LAB_PC/neural_stpp/data/crimeNYC10/crime_nyc_danger_day7-1.npz')
...
def Test(testlist):
    ...
    # p_wrap = lp(validate)
    # intensity = p_wrap(model, test_loader, testlist, t0, t1, device)
    # lp.print_stats()
...
def get_dataset(crime_id, processes_num=20):
    ...
    with multiprocessing.Pool(processes=processes_num) as pool:
        ...
        # print(output)
    ed = time.time()
    print('TIME:{}, Processes_num:{}'.format((ed - st) / 60, processes_num))
    pass
...
if __name__ == '__main__':
    # get_dataset(10, 2)
    # get_one()
    dataset_collection(10, '2023-05-09_15-16', 2, to_file='/home/tangjun/CrimePrediction_LAB_PC/data/NYC/pp_data/2023-5-10_12-00-o1', order='-o1')
    # multi_test()
    # one_test()
